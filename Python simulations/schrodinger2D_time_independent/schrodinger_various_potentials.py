...
if __name__ == "__main__":
    ...
    if executor:
        ...
        ymin = 0
        ymax = 1
        n_eigen = 1000  # how much eigenvalues and eigenvectors do you want?
        E0 = 0
    ...
    eigen = np.loadtxt(f"eigenvalues_{kindpot}.txt", dtype=str)
